    ...
    for (int i = 0; i < GGML_TYPE_COUNT; i++) {
        ...
        if (qfns_cpu->from_float && qfns->to_float) {
            ...
            const float max_quantization_error =
                ...
                // ROCmFPx sub-4-bit types: same budget as the other types of their width
                type == GGML_TYPE_Q3_0_ROCMFPX ? MAX_QUANTIZATION_TOTAL_ERROR_3BITS :
                type == GGML_TYPE_Q2_0_ROCMFPX ? MAX_QUANTIZATION_TOTAL_ERROR_2BITS : MAX_QUANTIZATION_TOTAL_ERROR;
